...
def generate_html_report(data_path, output_dir):
    ...
    # The image paths in the HTML template are relative to the HTML file, so we just need the filenames
    html_content = html_content.replace("correlation_heatmap.png", "correlation_heatmap.png")
    html_content = html_content.replace("sales_vs_unemployment_scatter.png", "sales_vs_unemployment_scatter.png")
    html_content = html_content.replace("time_series_trend.png", "time_series_trend.png")
    html_content = html_content.replace("store_avg_comparison.png", "store_avg_comparison.png")
